# Generated by Django 2.1.8 on 2020-04-21 00:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.utcnow, verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '首页轮播图',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.utcnow, verbose_name='创建时间')),
            ],
            options={
                'verbose_name': '商品',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(help_text='类别编码', max_length=50, verbose_name='类别编码')),
                ...
                ('is_tab', models.BooleanField(default=False, help_text='是否首页导航', verbose_name='是否首页导航')),
                ('add_time', models.DateTimeField(default=datetime.datetime.utcnow, verbose_name='添加时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='', help_text='品牌名字', max_length=50, verbose_name='品牌名字')),
                ('desc', models.TextField(default='', help_text='品牌描述', max_length=200, verbose_name='品牌描述')),
                ('image', models.ImageField(max_length=200, upload_to='brand/images/', verbose_name='图片上传')),
                ('add_time', models.DateTimeField(default=datetime.datetime.utcnow, verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '品牌',
